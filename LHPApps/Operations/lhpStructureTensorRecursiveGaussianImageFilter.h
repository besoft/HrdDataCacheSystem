/*=========================================================================
  ...
  Module:    $RCSfile: lhpStructureTensorRecursiveGaussianImageFilter.h,v $
  Language:  C++
  Date:      $Date: 2011-10-18 20:16:01 $
...
/*=========================================================================
// Adapted for OpenMaf from TubeTK library
// http://www.vtk.org/Wiki/TubeTK
=========================================================================*/

#ifndef __lhpStructureTensorRecursiveGaussianImageFilter_h
#define __lhpStructureTensorRecursiveGaussianImageFilter_h
...
#include "lhpStructureTensorRecursiveGaussianImageFilter.txx"
#endif
