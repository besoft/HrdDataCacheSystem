/*=========================================================================
  ...
  Module:    $RCSfile: lhpOpImporterMatrixOctave.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __lhpImporterMatrixOctave_H__
#define __lhpImporterMatrixOctave_H__
...
//----------------------------------------------------------------------------
//  lhpOpImporterMatrixOctave : Importing octave matrix to NMSBuilder
//----------------------------------------------------------------------------
/** read an octave matrix and apply it to a VME node */
class LHP_OPERATIONS_EXPORT lhpOpImporterMatrixOctave : public mafOp
{
public:
	/** Class constructor */
	lhpOpImporterMatrixOctave(const wxString &label = "Octave Matrix Importer");
	/** Class destructor */
	~ lhpOpImporterMatrixOctave(); 
...
protected:
	...
	/** remove white spaces at both ends of a string */
	std::string RemoveWhiteSpacesAtEnds(const std::string & str) const;
	/** read header information of an entity */
	HeaderOctave ReadHeader();
	/** read the contents of a matrix */
	MatrixOctave ReadMatrix(HeaderOctave & hdr) throw (OctaveImportException);
