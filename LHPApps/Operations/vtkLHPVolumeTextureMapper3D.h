/*=========================================================================
  ...
  Module:    $RCSfile: vtkLHPVolumeTextureMapper3D.h,v $
...
=========================================================================*/
// .NAME vtkLHPVolumeTextureMapper3D - volume render with 3D texture mapping

// .SECTION Description
// vtkLHPVolumeTextureMapper3D renders a volume using 3D texture mapping. 
...
// method. You should create a vtkLHPVolumeTextureMapper3D, assign its
...
#ifndef __lhpVolumeTextureMapper3D_H__
#define __lhpVolumeTextureMapper3D_H__
...
/**
copied and adapted from VTK5 vtkVolumeTextureMapper3D.
Changed the New() function to directly return vtkLHPOpenGLTextureMapper3D
instead of using vtkVolumeRenderingFactory
*/
class vtkLHPVolumeTextureMapper3D : public vtkVolumeMapper
{
public:
  vtkTypeRevisionMacro(vtkLHPVolumeTextureMapper3D,vtkVolumeMapper);
  void PrintSelf(ostream& os, vtkIndent indent);

  /** directly return vtkLHPOpenGLTextureMapper3D */
  static vtkLHPVolumeTextureMapper3D *New();
...
//ETX
  ...
  vtkSetClampMacro( PreferredRenderMethod, int, 
                    vtkLHPVolumeTextureMapper3D::FRAGMENT_PROGRAM_METHOD,
                    vtkLHPVolumeTextureMapper3D::NVIDIA_METHOD );
  void SetPreferredMethodToFragmentProgram()
    { this->SetPreferredRenderMethod( vtkLHPVolumeTextureMapper3D::FRAGMENT_PROGRAM_METHOD ); }
  void SetPreferredMethodToNVidia() 
    { this->SetPreferredRenderMethod( vtkLHPVolumeTextureMapper3D::NVIDIA_METHOD ); }
  vtkGetMacro(PreferredRenderMethod, int);


protected:
  vtkLHPVolumeTextureMapper3D();
  ~vtkLHPVolumeTextureMapper3D();
...
private:
  vtkLHPVolumeTextureMapper3D(const vtkLHPVolumeTextureMapper3D&);  // Not implemented.
  void operator=(const vtkLHPVolumeTextureMapper3D&);  // Not implemented.
};
