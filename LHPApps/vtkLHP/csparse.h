...
VTK_vtkLHP_EXPORT typedef struct cs_sparse    /* matrix in compressed-column or triplet form */
{
...
VTK_vtkLHP_EXPORT cs *cs_add (const cs *A, const cs *B, double alpha, double beta) ;
VTK_vtkLHP_EXPORT int cs_cholsol (const cs *A, double *b, int order) ;
VTK_vtkLHP_EXPORT int cs_dupl (cs *A) ;
VTK_vtkLHP_EXPORT int cs_entry (cs *T, int i, int j, double x) ;
VTK_vtkLHP_EXPORT int cs_lusol (const cs *A, double *b, int order, double tol) ;
VTK_vtkLHP_EXPORT int cs_gaxpy (const cs *A, const double *x, double *y) ;
VTK_vtkLHP_EXPORT cs *cs_multiply (const cs *A, const cs *B) ;
VTK_vtkLHP_EXPORT int cs_qrsol (const cs *A, double *b, int order) ;
VTK_vtkLHP_EXPORT cs *cs_transpose (const cs *A, int values) ;
VTK_vtkLHP_EXPORT cs *cs_triplet (const cs *T) ;
VTK_vtkLHP_EXPORT double cs_norm (const cs *A) ;
VTK_vtkLHP_EXPORT int cs_print (const cs *A, int brief) ;
VTK_vtkLHP_EXPORT cs *cs_load (FILE *f) ;
/* utilities */
VTK_vtkLHP_EXPORT void *cs_calloc (int n, size_t size) ;
VTK_vtkLHP_EXPORT void *cs_calloc (int n, size_t size) ;
VTK_vtkLHP_EXPORT void *cs_free (void *p) ;
VTK_vtkLHP_EXPORT void *cs_realloc (void *p, int n, size_t size, int *ok) ;
VTK_vtkLHP_EXPORT cs *cs_spalloc (int m, int n, int nzmax, int values, int triplet) ;
VTK_vtkLHP_EXPORT cs *cs_spfree (cs *A) ;
VTK_vtkLHP_EXPORT int cs_sprealloc (cs *A, int nzmax) ;
VTK_vtkLHP_EXPORT void *cs_malloc (int n, size_t size) ;
...
VTK_vtkLHP_EXPORT csd *cs_dmperm (const cs *A) ;
VTK_vtkLHP_EXPORT int cs_droptol (cs *A, double tol) ;
VTK_vtkLHP_EXPORT int cs_dropzeros (cs *A) ;
...
css *cs_sfree (css *S) ;
csn *cs_nfree (csn *N) ;
VTK_vtkLHP_EXPORT csd *cs_dfree (csd *D) ;
...
VTK_vtkLHP_EXPORT int cs_fkeep (cs *A, int (*fkeep) (int, int, double, void *), void *other) ;
