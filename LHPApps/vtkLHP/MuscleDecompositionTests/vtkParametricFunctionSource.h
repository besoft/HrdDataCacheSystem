...
class vtkParametricFunctionSource : public vtkPolyDataSource
{
public:
  vtkTypeMacro(vtkParametricFunctionSource,vtkPolyDataSource);
...
private:
  ...
  void Produce1DOutput(vtkDataObject *output);
  void Produce2DOutput(vtkDataObject *output);
