...
namespace CacheSystem
{
	...
	*/
	...
	std::shared_ptr<CacheData> CacheDataStructure::getCacheData(const std::vector<std::shared_ptr<ParameterInfo> > & paramsInfo, void* dependencyObject, const Types &... params)
	{
